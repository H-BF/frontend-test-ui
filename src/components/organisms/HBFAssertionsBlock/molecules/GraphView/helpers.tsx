...
export const ProtocolNodeLeft: FC<{ data: any }> = ({ data }) => (
  <Styled.ProtocolNodeContainer $handleType={data?.handleType} $status={data?.status} $type="left">
...
export const ProtocolNodeRight: FC<{ data: any }> = ({ data }) => (
  <Styled.ProtocolNodeContainer $handleType={data?.handleType} $status={data?.status} $type="right">
    {data?.label}
...
export const NetworkNode: FC<{ data: any }> = ({ data }) => (
  <Styled.NetworkNodeContainer $status={data?.status}>{data?.label}</Styled.NetworkNodeContainer>
)

export const IpAndProtocolNodeLeft: FC<{ data: any }> = ({ data }) => (
  <Styled.IpAndProtocolNodeContainer $handleType={data?.handleType} $status={data?.status}>
    {data?.label}
    <Handle type="source" isConnectable={false} position={Position.Right} />
    <Handle type="target" isConnectable={false} position={Position.Right} />
